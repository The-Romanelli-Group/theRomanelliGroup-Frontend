            ...
            <div className="container px-5 lg:px-24 pt-12 mx-auto ">
                <div className="flex flex-col text-center w-full">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-xl">
                        Explore our proudest moments—because every sold home is a success story we’re honored to be part of. Just a quick sneak peak into some of the smiling faces of my happy past clients.
                    </p>
                </div>
            </div>
