...
<>
  ...
  <section className="bg-backgroundColor pt-24 pb-16">
    ...
    <div className="max-w-7xl mx-auto px-5 lg:px-8">
      ...
      <div className="mt-14 overflow-hidden rounded-[36px] border border-white/10 shadow-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
        ...
        <article className="lg:col-span-8">
          ...
          {blog.excerpt && (
            ...
            <div className="mb-12 rounded-[30px] border border-gray-200 bg-gray-50 p-8">
        ...
        <aside className="lg:col-span-4">
          ...
          <div className="sticky top-28">
            ...
            <div className="rounded-[30px] border border-gray-200 bg-white shadow-xl p-8">

              <span className="inline-flex rounded-full bg-[#A61E22]/10 px-4 py-2 text-xs font-semibold uppercase tracking-widest text-[#A61E22]">
                Need Guidance?
              </span>
              ...
              <button
                ...
                className="mt-4 w-full rounded-2xl border border-gray-300 bg-white py-4 font-semibold text-gray-900 transition hover:bg-gray-100"
              >
                Browse Properties
              </button>
  ...
  <div className="max-w-7xl mx-auto px-5 lg:px-8">
    ...
    <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
      ...
      <div>
        ...
        <span className="text-[#A61E22] uppercase tracking-[0.2em] text-sm font-semibold">
          Keep Reading
        </span>
        ...
        <p className="mt-3 text-gray-400 max-w-xl">
          Continue exploring expert advice, market updates and buying insights.
        </p>
      ...
      <button
        onClick={() => navigate("/resources")}
        className="rounded-full bg-[#A61E22] px-7 py-3 font-semibold text-white transition hover:bg-[#8E1A1D]"
      >
        View All Resources
      </button>
    ...
    {relatedBlogs.length > 0 ? (
      ...
      <div className="mt-14 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8">
        ...
        {relatedBlogs.map((item) => (
          ...
          <article
            key={item.id}
            className="overflow-hidden rounded-[32px] bg-[#1D1D1D] border border-white/10 transition-all duration-300 hover:-translate-y-2 hover:border-[#A61E22]/40"
          >
            ...
            <div className="p-7">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="rounded-full bg-[#A61E22]/15 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-[#D64B4F]">
              ...
              {item.longDescription && (
                <p className="mt-4 text-gray-400 leading-7 line-clamp-2">
                  {item.longDescription}
                </p>
              )}
              ...
              <button
                ...
                className="mt-8 flex items-center gap-3 font-semibold text-[#D64B4F] transition hover:gap-4"
              >
                Read Article
      ...
      <div className="mt-14 rounded-[30px] border border-white/10 bg-white/5 p-12 text-center">
        ...
        <button
          onClick={() => navigate("/resources")}
          className="mt-8 rounded-full bg-[#A61E22] px-7 py-3 font-semibold text-white transition hover:bg-[#8E1A1D]"
        >
          Browse Resources
        </button>
